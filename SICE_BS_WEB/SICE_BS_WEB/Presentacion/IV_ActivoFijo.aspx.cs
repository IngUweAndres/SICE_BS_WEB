...
{
    public partial class IV_ActivoFijo : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    RANGO.Text = DESDE.Text = HASTA.Text = PEDIMENTO.Text = string.Empty;
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            if ((dateDesde == null && dateHasta != null) || (dateDesde != null && dateHasta == null))
            {
            ...
            dt = informes.ConsultarActivoFijo(dateDesde, dateHasta, PEDIMENTO.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Activo Fijo");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Activo Fijo", new XlsExportOptionsEx() { SheetName = "Activo Fijo" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Activo Fijo", new XlsxExportOptionsEx() { SheetName = "Activo Fijo" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IA_CuentasGasto : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                excepcion.RegistrarExcepcion(idusuario, "IA_CuentasGasto-Page_Load", ex, lblCadena.Text, ref mensaje);
                if (mensaje.Length == 0)
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarCG(PEDIMENTO.Text, dateDesde, dateHasta, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Cuentas de  Gasto");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Cuentas de  Gasto", new XlsExportOptionsEx() { SheetName = "Cuentas de  Gasto" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Cuentas de  Gasto", new XlsxExportOptionsEx() { SheetName = "Cuentas de  Gasto" });
                        break;
                    default:
                        break;
                }

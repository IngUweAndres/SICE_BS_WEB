...
{
    public partial class IG_DestinatarioMercancia : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarDestinatarioMercancia(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Destinatario de la Mercancía");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Destinatario de la Mercancía", new XlsExportOptionsEx() { SheetName = "Destinatario de la Mercancía" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Destinatario de la Mercancía", new XlsxExportOptionsEx() { SheetName = "Destinatario de la Mercancía" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IG_DescargoMercancias : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarDescargosMercancia(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Descargo de Mercancías");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Descargo de Mercancías", new XlsExportOptionsEx() { SheetName = "Descargo de Mercancías" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Descargo de Mercancías", new XlsxExportOptionsEx() { SheetName = "Descargo de Mercancías" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IA_DTA : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarDTA(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("DTA por Partida");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("DTA por Partida", new XlsExportOptionsEx() { SheetName = "DTA por Partida" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("DTA por Partida", new XlsxExportOptionsEx() { SheetName = "DTA por Partida" });
                        break;
                    default:
                        break;
                }

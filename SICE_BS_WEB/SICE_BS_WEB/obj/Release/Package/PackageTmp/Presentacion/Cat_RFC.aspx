<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="Cat_RFC.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.Cat_RFC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentSection" runat="server">
             ...
             <div class="panel-body">
                 ...
                 <%--<div class="row" style="padding-left:10px; padding-top:10px; padding-right:10px;">   --%>                                     
                    <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                        ...
                        AutoGenerateColumns="False" Width="100%" Settings-HorizontalScrollBarMode="Auto" KeyFieldName="RFC" SettingsPager-Position="TopAndBottom"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn Caption="RFC" FieldName="RFC" ReadOnly="True" VisibleIndex="1" Width="100%" >
                        ...
                        <dx:GridViewToolbar Name="Toolbar1" EnableAdaptivity="true" ItemAlign="Left">
                            <Items>
                                ...
                                <Template>
                                    <asp:LinkButton ID="lkb_Nuevo" runat="server" OnClick="lkb_Nuevo_Click" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Nuevo RFC" data-toggle="tooltip">
                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Nuevo
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lkb_Editar" runat="server" OnClick="lkb_Editar_Click" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Editar RFC" data-toggle="tooltip">
                                        <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Editar
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lkb_Eliminar" runat="server" OnClick="lkb_Eliminar_Click" OnClientClick="alertQuestion('¿Desea eliminar este RFC?', this); return false;" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Eliminar RFC" data-toggle="tooltip">
    ...
    <button id="btnModalRFC" type="button" data-toggle="modal" data-target="#ModalRFC" data-whatever="Nuevo" onclick="return false;" style="display: none;"></button>
    <div class="modal fade" id="ModalRFC" tabindex="-1" role="dialog" aria-labelledby="ModalRFCTitulo" data-backdrop="static">
        <div class="modal-dialog modal-sm" role="document" >
            <div class="modal-content">
                <div class="modal-header">
                    <h4 id="ModalRFCTitulo" class="modal-title" runat="server"></h4>                    
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">                                
                                <div runat="server" id="Div1">
                                    <div class="form-group" style="position: relative; width: 100%; float: left;" title="RFC" data-toggle="tooltip">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">
                                                <span class="glyphicon glyphicon-credit-card" aria-hidden="true"></span>
                                            </span>
                                            <asp:TextBox ID="txt_RFC" runat="server" CssClass="form-control input-sm" MaxLength="50" placeholder="* RFC"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>

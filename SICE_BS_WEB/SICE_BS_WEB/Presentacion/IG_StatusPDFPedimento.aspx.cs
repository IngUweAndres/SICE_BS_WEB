...
{
    public partial class IG_StatusPDFPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarStatusPDFVsPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Informe Status PDF Vs Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Informe Status PDF Vs Pedimento", new XlsExportOptionsEx() { SheetName = "Informe Status PDF Vs Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Informe Status PDF Vs Pedimento", new XlsxExportOptionsEx() { SheetName = "Informe Status PDF Vs Pedimento" });
                        break;
                    default:
                        break;
                }

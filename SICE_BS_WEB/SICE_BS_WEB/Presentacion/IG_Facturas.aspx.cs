...
{
    public partial class IG_Facturas : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("Facturas", PEDIMENTO.Text, dateDesde, dateHasta, ref mensaje);
            dt = infogral.ConsultarFacturas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Facturas");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Facturas", new XlsExportOptionsEx() { SheetName = "Facturas" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Facturas", new XlsxExportOptionsEx() { SheetName = "Facturas" });
                        break;
                    default:
                        break;
                }

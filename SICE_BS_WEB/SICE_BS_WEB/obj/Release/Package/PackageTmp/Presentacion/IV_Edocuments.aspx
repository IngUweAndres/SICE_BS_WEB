<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IV_Edocuments.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IV_Edocuments" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" align="center">
                 ...
                 <div class="row" style="padding-left:10px; padding-top:10px; padding-right:10px;">
                    ...
                    <div class="col-sm-4 col-md-2">
                        <div runat="server" id="DivED">
                            <div class="form-group" style="position: relative; width: 100%; float: left;" title="Edocument" data-toggle="tooltip">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon5">
                                        <span class="glyphicon glyphicon-option-horizontal" aria-hidden="true"></span>
                                    </span>
                                    <asp:TextBox ID="EDOCUMENT" runat="server" CssClass="form-control input-sm" MaxLength="50" placeholder="Edocument"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div> 
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    OnCustomCallback="Grid_CustomCallback" EnableCallBacks="false" ClientInstanceName="grid" AutoGenerateColumns="False" Width="84%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="FECHA" FieldName="FECHA" ReadOnly="True" VisibleIndex="2" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="3" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="EDOCUMENT" FieldName="EDOCUMENT" ReadOnly="True" VisibleIndex="4" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PATENTE" FieldName="PATENTE" ReadOnly="True" VisibleIndex="5" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RFC AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="6" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="STATUS DOCUMENTO" FieldName="STATUS DOCUMENTO" ReadOnly="True" VisibleIndex="7" Width="166px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="DESCRIPCIÓN" FieldName="DESCRIPCION" ReadOnly="True" VisibleIndex="8" Width="600px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>                           
                    </Columns>                    

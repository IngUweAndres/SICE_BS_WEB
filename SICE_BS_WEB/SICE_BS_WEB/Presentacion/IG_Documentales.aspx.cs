...
{
    public partial class IG_Documentales : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarDocumentales(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Documentales");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Documentales", new XlsExportOptionsEx() { SheetName = "Documentales" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Documentales", new XlsxExportOptionsEx() { SheetName = "Documentales" });
                        break;
                    default:
                        break;
                }

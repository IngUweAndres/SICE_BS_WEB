<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IA_CVDT.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IA_CVDT" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    Settings-HorizontalScrollBarMode="Auto" KeyFieldName="PEDIMENTO ARMADO" SettingsPager-Position="TopAndBottom" 
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO ARMADO" FieldName="PEDIMENTO ARMADO" ReadOnly="True" VisibleIndex="1" Width="170px" >
                        ...
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO ORIGINAL" FieldName="PEDIMENTO ORIGINAL" ReadOnly="True" VisibleIndex="3" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn Caption="CLAVE DOCUMENTO" FieldName="CLAVE DOCUMENTO" ReadOnly="True" VisibleIndex="4" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                  
                        <dx:GridViewDataTextColumn Caption="TIPO OPERACIÓN" FieldName="TIPO OPERACIÓN" ReadOnly="True" VisibleIndex="5" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="TIPO PEDIMENTO" FieldName="TIPO PEDIMENTO" ReadOnly="True" VisibleIndex="6" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>                       
                        <dx:GridViewDataTextColumn Caption="DS" FieldName="DS" ReadOnly="True" VisibleIndex="7" Width="70px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM" FieldName="VUCEM" ReadOnly="True" VisibleIndex="8" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DS VALOR ADUANA" FieldName="DS VALOR ADUANA" ReadOnly="True" VisibleIndex="9" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM VALOR ADUANA" FieldName="VUCEM VALOR ADUANA" ReadOnly="True" VisibleIndex="10" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA VALOR ADUANA" FieldName="DIFERENCIA VALOR ADUANA" ReadOnly="True" VisibleIndex="11" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DS VALOR COMERCIAL" FieldName="DS VALOR COMERCIAL" ReadOnly="True" VisibleIndex="12" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM VALOR COMERCIAL" FieldName="VUCEM VALOR COMERCIAL" ReadOnly="True" VisibleIndex="13" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA VALOR COMERCIAL" FieldName="DIFERENCIA VALOR COMERCIAL" ReadOnly="True" VisibleIndex="14" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />                          
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DS VALOR DOLARES" FieldName="DS VALOR DOLARES" ReadOnly="True" VisibleIndex="15" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM VALOR DOLARES" FieldName="VUCEM VALOR DOLARES" ReadOnly="True" VisibleIndex="16" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA VALOR DOLARES" FieldName="DIFERENCIA VALOR DOLARES" ReadOnly="True" VisibleIndex="17" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DS VALOR IVA" FieldName="DS VALOR IVA" ReadOnly="True" VisibleIndex="18" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM VALOR IVA" FieldName="VUCEM VALOR IVA" ReadOnly="True" VisibleIndex="19" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA VALOR IVA" FieldName="DIFERENCIA VALOR IVA" ReadOnly="True" VisibleIndex="20" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DS VALOR DTA" FieldName="DS VALOR DTA" ReadOnly="True" VisibleIndex="21" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VUCEM VALOR DTA" FieldName="VUCEM VALOR DTA" ReadOnly="True" VisibleIndex="22" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA VALOR DTA" FieldName="DIFERENCIA VALOR DTA" ReadOnly="True" VisibleIndex="23" Width="180px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <PropertiesTextEdit DisplayFormatString="{0:n0}" />
                        </dx:GridViewDataTextColumn>              
                    ...
                    <TotalSummary>
                        <dx:ASPxSummaryItem FieldName="VALOR USD" SummaryType="Sum" DisplayFormat="{0:n2}" />
                        <dx:ASPxSummaryItem FieldName="VALOR COMERCIAL" SummaryType="Sum" DisplayFormat="{0:n2}" />
                    </TotalSummary>                     
                 </dx:ASPxGridView>

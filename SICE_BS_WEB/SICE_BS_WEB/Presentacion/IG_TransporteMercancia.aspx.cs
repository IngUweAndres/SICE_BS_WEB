...
{
    public partial class IG_TransporteMercancia : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarTransporteMercancia(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Transporte de Mercancías");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Transporte de Mercancías", new XlsExportOptionsEx() { SheetName = "Transporte de Mercancías" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Transporte de Mercancías", new XlsxExportOptionsEx() { SheetName = "Transporte de Mercancías" });
                        break;
                    default:
                        break;
                }

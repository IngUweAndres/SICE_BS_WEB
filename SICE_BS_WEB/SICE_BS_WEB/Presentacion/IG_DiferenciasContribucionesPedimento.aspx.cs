...
{
    public partial class IG_DiferenciasContribucionesPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarDiferenciasContribucionesPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Diferencias en Contribuciones del Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Diferencias en Contribuciones del Pedimento", new XlsExportOptionsEx() { SheetName = "Diferencias en Contribuciones del Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Diferencias en Contribuciones del Pedimento", new XlsxExportOptionsEx() { SheetName = "Diferencias en Contribuciones del Pedimento" });
                        break;
                    default:
                        break;
                }

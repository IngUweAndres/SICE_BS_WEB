...
{
    public partial class IG_ObservacionesPartidas : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarObservacionesPartidas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Observaciones de las Partidas");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Observaciones de las Partidas", new XlsExportOptionsEx() { SheetName = "Observaciones de las Partidas" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Observaciones de las Partidas", new XlsxExportOptionsEx() { SheetName = "Observaciones de las Partidas" });
                        break;
                    default:
                        break;
                }

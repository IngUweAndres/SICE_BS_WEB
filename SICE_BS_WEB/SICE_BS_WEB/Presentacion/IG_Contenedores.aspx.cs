...
{
    public partial class IG_Contenedores : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("Contenedores", PEDIMENTO.Text, dateDesde, dateHasta, lblCadena.Text,ref mensaje);
            dt = infogral.ConsultarContenedores(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Contenedores");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Contenedores", new XlsExportOptionsEx() { SheetName = "Contenedores" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Contenedores", new XlsxExportOptionsEx() { SheetName = "Contenedores" });
                        break;
                    default:
                        break;
                }

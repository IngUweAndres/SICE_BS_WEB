...
{
    public partial class IG_DatosGenerales : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("DatosGenerales", PEDIMENTO.Text, dateDesde, dateHasta, lblCadena.Text, ref mensaje);
            dt = infogral.ConsultarDatosGenerales(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        {
            e.Command.Parameters["@PEDIMENTOARMADO"].Value = PEDIMENTO.Text == null ? Convert.DBNull : PEDIMENTO.Text;
            e.Command.Parameters["@DESDE"].Value = DESDE == null ? Convert.DBNull : DESDE;
            e.Command.Parameters["@HASTA"].Value = HASTA == null ? Convert.DBNull : HASTA;
            //e.Command.Parameters["mensaje"].Value = ASPx_Mensaje.Text;
        }
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            ...
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Datos Generales");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Datos Generales", new XlsExportOptionsEx() { SheetName = "Datos Generales" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Datos Generales", new XlsxExportOptionsEx() { SheetName = "Datos Generales" });
                        break;
                    default:
                        break;
                }

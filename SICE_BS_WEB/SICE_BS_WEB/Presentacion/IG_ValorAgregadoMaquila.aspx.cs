...
{
    public partial class IG_ValorAgregadoMaquila : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarValorAgregadoMaquila(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Informe Valor Agregado Maquila");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Informe Valor Agregado Maquila", new XlsExportOptionsEx() { SheetName = "Informe Valor Agregado Maquila" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Informe Valor Agregado Maquila", new XlsxExportOptionsEx() { SheetName = "Informe Valor Agregado Maquila" });
                        break;
                    default:
                        break;
                }

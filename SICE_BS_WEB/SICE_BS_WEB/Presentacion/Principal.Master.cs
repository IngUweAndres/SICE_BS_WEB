    ...
    public partial class Principal : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["Menu"] != null)
                {
                    navBarCollapse.Controls.Add(new LiteralControl(Session["Menu"].ToString()));
        ...
        public void ColoresMenuFooter()
        {
            if (Session["MenuBackColor"] != null)
            {
                //Pinta el menú y el footer(background y text)
                ImgLogo.Visible = true;
                ImgLogo.Src = "../Presentacion/Logo/logo_izquierdo.bmp";
                NavMenu.Style.Value = "background-color: " + Session["MenuBackColor"].ToString() + "; ";
                divFooter.Style.Value = "background-color: " + Session["MenuBackColor"].ToString() + "; ";
                foH6.Attributes.Add("style", "color:" + Session["MenuFontColor"].ToString());
            }

            if (Session["ButtonBackColor"] != null)
                DevExpress.Web.ASPxWebControl.GlobalThemeBaseColor = Session["ButtonBackColor"].ToString();
        }
    }
}
...
{
    public partial class IG_CuentasAduanerasGarantiaPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("TransporteMercancia", PEDIMENTO.Text, dateDesde, dateHasta, lblCadena.Text, ref mensaje);
            dt = infogral.ConsultarCuentasAduanerasGarantiaPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Cuentas Aduaneras de Garantía del Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Cuentas Aduaneras de Garantía del Pedimento", new XlsExportOptionsEx() { SheetName = "Cuentas Aduaneras de Garantía del Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Cuentas Aduaneras de Garantía del Pedimento", new XlsxExportOptionsEx() { SheetName = "Cuentas Aduaneras de Garantía del Pedimento" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class CargasDataStage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch(Exception ex)
            {
                ...
                excepcion.RegistrarExcepcion(idusuario, "CargasDataStage-Page_Load", ex, Session["Cadena"].ToString(), ref mensaje);
            }
        }
        ...
        protected void ASPxUploadControl1_FileUploadComplete(object sender, DevExpress.Web.FileUploadCompleteEventArgs e)
        {
            ...
            try
            {
                ...
                if (Session["Grid"] != null && ((DataTable)(Session["Grid"])).Rows.Count > 0)
                {
                    ...
                    {
                        if (fila["DSNAME"].ToString().Trim().ToUpper() == e.UploadedFile.FileName.Trim().ToUpper())
                        {
                ...
                string cmdString = "INSERT INTO [dbo].[FILESDS] (FILESDSKEY,[DSNAME],[ARCHIVO],[STATUSDS]) VALUES (NEWID(),@val1,@file,@val2)";
                ...
                if (Session["IdUsuario"] != null)
                    idusuario = int.Parse(Session["IdUsuario"].ToString());
                excepcion.RegistrarExcepcion(idusuario, "CargasDataStage-ASPxUploadControl1_FileUploadComplete", ex, Session["Cadena"].ToString(), ref mensaje);
            }
        }
        ...
        //Por cada renglon en el grid entrará al metodo, se usa para inhabilitar botón de PROCESAR ARCHIVO
        ...
        {            
            ...
            {
                ASPxGridView grid = sender as ASPxGridView;
                var status = grid.GetRowValues(e.VisibleIndex, "STATUSDS");
        ...
        protected void UpdateGrid()
        {
            ...
            string cmdString = "SELECT [FILESDSKEY], [DSNAME], [DESDE], [HASTA], [STATUSDS], [OBSERVACIONES], [REGISTROS501] FROM [FILESDS] ORDER BY [DSNAME], [FILESDSKEY]";
            string connString = Session["Cadena"].ToString();
        ...
        protected void lkb_Excel_Click(object sender, EventArgs e)
        {
            ...
            {
                Exporter.WriteXlsToResponse("CargasDataStage", new XlsExportOptionsEx() { SheetName = "CargasDataStage" });
            }
            else

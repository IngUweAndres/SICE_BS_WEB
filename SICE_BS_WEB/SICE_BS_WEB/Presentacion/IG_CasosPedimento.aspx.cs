...
{
    public partial class IG_CasosPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("FechasPedimento", PEDIMENTO.Text, dateDesde, dateHasta, lblCadena.Text,ref mensaje);
            dt = infogral.ConsultarCasosPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Casos Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Casos Pedimento", new XlsExportOptionsEx() { SheetName = "Casos Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Casos Pedimento", new XlsxExportOptionsEx() { SheetName = "Casos Pedimento" });
                        break;
                    default:
                        break;
                }

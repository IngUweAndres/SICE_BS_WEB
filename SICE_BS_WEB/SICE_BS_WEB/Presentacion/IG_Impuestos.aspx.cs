...
{
    public partial class IG_Impuestos : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarImpuestos(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Impuestos");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Impuestos", new XlsExportOptionsEx() { SheetName = "Impuestos" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Impuestos", new XlsxExportOptionsEx() { SheetName = "Impuestos" });
                        break;
                    default:
                        break;
                }

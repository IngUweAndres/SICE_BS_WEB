...
{
    public partial class IG_ContribucionesDelPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarContribucionesDelPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Contribuciones del Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Contribuciones del Pedimento", new XlsExportOptionsEx() { SheetName = "Contribuciones del Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Contribuciones del Pedimento", new XlsxExportOptionsEx() { SheetName = "Contribuciones del Pedimento" });
                        break;
                    default:
                        break;
                }

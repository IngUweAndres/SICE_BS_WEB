...
{
    public partial class IV_Edocuments : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarEdocument(dateDesde, dateHasta, PEDIMENTO.Text, EDOCUMENT.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Edocuments");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Edocuments", new XlsExportOptionsEx() { SheetName = "Edocuments" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Edocuments", new XlsxExportOptionsEx() { SheetName = "Edocuments" });
                        break;
                    default:
                        break;
                }

<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IV_CovePedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IV_CovePedimento" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <div class="row" style="padding-left:10px; padding-top:10px; padding-right:10px;">
                    ...
                    <div class="col-sm-4 col-md-2">
                        <div runat="server" id="DivCove">
                            <div class="form-group" style="position: relative; width: 100%; float: left;" title="Cove" data-toggle="tooltip">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon5">
                                        <span class="glyphicon glyphicon-option-horizontal" aria-hidden="true"></span>
                                    </span>
                                    <asp:TextBox ID="COVE" runat="server" CssClass="form-control input-sm" MaxLength="50" placeholder="Cove"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div> 
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="TIPO OPERACIÓN" FieldName="TIPO DE OPERACIÓN" ReadOnly="True" VisibleIndex="2" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA" FieldName="FECHA" ReadOnly="True" VisibleIndex="3" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="COVE" FieldName="COVE" ReadOnly="True" VisibleIndex="4" Width="250px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FACTURA" FieldName="FACTURA" ReadOnly="True" VisibleIndex="5" Width="250px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA FACTURA" FieldName="FECHA FACTURA" ReadOnly="True" VisibleIndex="6" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="PROVEEDOR/COMPRADOR" FieldName="PROVEEDOR / COMPRADOR" ReadOnly="True" VisibleIndex="7" Width="330px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="MONEDA" FieldName="MONEDA" ReadOnly="True" VisibleIndex="8" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DLLS" FieldName="VALOR DLLS" ReadOnly="True" VisibleIndex="9" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR ME" FieldName="VALOR ME" ReadOnly="True" VisibleIndex="10" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="11" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="ERROR" FieldName="ERROR" ReadOnly="True" VisibleIndex="12" Width="180px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>       
                    </Columns>                    

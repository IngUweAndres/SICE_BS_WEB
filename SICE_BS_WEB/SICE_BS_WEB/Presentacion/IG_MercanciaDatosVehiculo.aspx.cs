...
{
    public partial class IG_MercanciaDatosVehiculo : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarMercanciaDatosVehiculos(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Mercancías (Datos Vehículos)");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Mercancías (Datos Vehículos)", new XlsExportOptionsEx() { SheetName = "Mercancías (Datos Vehículos)" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Mercancías (Datos Vehículos)", new XlsxExportOptionsEx() { SheetName = "Mercancías (Datos Vehículos)" });
                        break;
                    default:
                        break;
                }

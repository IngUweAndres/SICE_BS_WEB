<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_StatusPDFPedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_StatusPDFPedimento" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="TIPO DE PEDIMENTO" FieldName="TIPO DE PEDIMENTO" ReadOnly="True" VisibleIndex="4" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="5" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO ORIGINAL" FieldName="PEDIMENTO ORIGINAL" ReadOnly="True" VisibleIndex="6" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PATENTE" FieldName="PATENTE" ReadOnly="True" VisibleIndex="7" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO ARCHIVO" FieldName="TIPO ARCHIVO" ReadOnly="True" VisibleIndex="8" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SUFIJO" FieldName="SUFIJO" ReadOnly="True" VisibleIndex="9" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="TIPO OPERACIÓN ARCHIVO" FieldName="TIPO_OPERACION_ARCHIVO" ReadOnly="True" VisibleIndex="10" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="NOMBRE ARCHIVO" FieldName="NOMBREARCHIVO" ReadOnly="True" VisibleIndex="11" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="EXISTE" FieldName="EXISTE" ReadOnly="True" VisibleIndex="12" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="OBLIGATORIO" FieldName="OBLIGATORIO" ReadOnly="True" VisibleIndex="13" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IDTL" FieldName="IDTL" ReadOnly="True" VisibleIndex="14" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="OPERACIÓN COMPLETA" FieldName="OPERACION_COMPLETA" ReadOnly="True" VisibleIndex="15" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                          
                    </Columns>                    

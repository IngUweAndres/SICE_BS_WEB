<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_CasosPedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_CasosPedimento" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="FECHA" FieldName="FECHA" ReadOnly="True" VisibleIndex="2" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        ...
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN TIPO DE OPERACIÓN" FieldName="DESCRIPCION TIPO DE OPERACION" ReadOnly="True" VisibleIndex="4" Width="300px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="CLAVE IDENTIFICADOR" FieldName="CLAVE IDENTIFICADOR" ReadOnly="True" VisibleIndex="10" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN DE LA CLAVE" FieldName="DESCRIPCIÓN DE LA CLAVE" ReadOnly="True" VisibleIndex="11" Width="1000px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="COMPLEMENTO 1" FieldName="COMPLEMENTO 1" ReadOnly="True" VisibleIndex="12" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                         
                        <dx:GridViewDataTextColumn Caption="CLAVE PAÍS DESTINO" FieldName="CLAVE PAIS DESTINO" ReadOnly="True" VisibleIndex="13" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PAÍS DESTINO" FieldName="PAIS DESTINO" ReadOnly="True" VisibleIndex="14" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE ADUANA" FieldName="CLAVE ADUANA" ReadOnly="True" VisibleIndex="15" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ADUANA" FieldName="ADUANA" ReadOnly="True" VisibleIndex="16" Width="290px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PESO BRUTO" FieldName="PESO BRUTO" ReadOnly="True" VisibleIndex="17" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="18" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA" FieldName="MEDIO DE TRANSPORTE SALIDA" ReadOnly="True" VisibleIndex="19" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE SALIDA DESCRIPCION" ReadOnly="True" VisibleIndex="20" Width="380px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO" FieldName="MEDIO DE TRANSPORTE ARRIBO" ReadOnly="True" VisibleIndex="21" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ARRIBO DESCRIPCION" ReadOnly="True" VisibleIndex="22" Width="380px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA" FieldName="MEDIO DE TRANSPORTE ENTRADA" ReadOnly="True" VisibleIndex="23" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ENTRADA DESCRIPCION" ReadOnly="True" VisibleIndex="24" Width="380px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CURP APODERADO MANDATARIO" FieldName="CURP APODERADO MANDATARIO" ReadOnly="True" VisibleIndex="25" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                              
                        <dx:GridViewDataTextColumn Caption="RFC AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="26" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DÓLARES" FieldName="VALOR DOLARES" ReadOnly="True" VisibleIndex="27" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANAL" FieldName="VALOR ADUANAL" ReadOnly="True" VisibleIndex="28" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL" FieldName="VALOR COMERCIAL" ReadOnly="True" VisibleIndex="29" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                    </Columns>

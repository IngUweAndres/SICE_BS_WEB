<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_ContribucionesPorPedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_ContribucionesPorPedimento" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="PARTIDA" FieldName="PARTIDA" ReadOnly="True" VisibleIndex="10" Width="160px">                            
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE" FieldName="CLAVE" ReadOnly="True" VisibleIndex="11" Width="160px">                            
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN" FieldName="DESCRIPCIÓN" ReadOnly="True" VisibleIndex="12" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FORMA DE PAGO CLAVE" FieldName="FORMA DE PAGO CLAVE" ReadOnly="True" VisibleIndex="13" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="FORMA DE PAGO DESCRIPCIÓN" FieldName="FROMA DE PAGO DESCRIPCIÓN" ReadOnly="True" VisibleIndex="14" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FORMA DE PAGO IMPORTE" FieldName="FORMA DE PAGO IMPORTE" ReadOnly="True" VisibleIndex="15" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn Caption="CONTRIBUCIÓN CLAVE" FieldName="CONTRIBUCION CLAVE" ReadOnly="True" VisibleIndex="16" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CONTRIBUCIÓN DESCRIPCIÓN" FieldName="CONTRIBUCION DESCRIPCION" ReadOnly="True" VisibleIndex="17" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA CLAVE" FieldName="TASA CLAVE" ReadOnly="True" VisibleIndex="18" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA DESCRIPCIÓN" FieldName="TASA DESCRIPCION" ReadOnly="True" VisibleIndex="19" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA APLICABLE" FieldName="TASA APLICABLE" ReadOnly="True" VisibleIndex="20" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA FORMA DE PAGO CLAVE" FieldName="TASA FORMA DE PAGO CLAVE" ReadOnly="True" VisibleIndex="20" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA FORMA DE PAGO DESCRIPCIÓN" FieldName="TASA FORMA DE PAGO DESCRIPCION" ReadOnly="True" VisibleIndex="20" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IMPORTE" FieldName="IMPORTE" ReadOnly="True" VisibleIndex="21" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="CLAVE PAÍS DESTINO" FieldName="CLAVE PAIS DESTINO" ReadOnly="True" VisibleIndex="23" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                       
                        <dx:GridViewDataTextColumn Caption="PAÍS DESTINO" FieldName="PAIS DESTINO" ReadOnly="True" VisibleIndex="24" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="CLAVE ADUANA" FieldName="CLAVE ADUANA" ReadOnly="True" VisibleIndex="25" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ADUANA" FieldName="ADUANA" ReadOnly="True" VisibleIndex="26" Width="330px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PESO BRUTO" FieldName="PESO BRUTO" ReadOnly="True" VisibleIndex="27" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="28" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA" FieldName="MEDIO DE TRANSPORTE SALIDA" ReadOnly="True" VisibleIndex="29" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE SALIDA DESCRIPCION" ReadOnly="True" VisibleIndex="30" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO" FieldName="MEDIO DE TRANSPORTE ARRIBO" ReadOnly="True" VisibleIndex="31" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ARRIBO DESCRIPCION" ReadOnly="True" VisibleIndex="32" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA" FieldName="MEDIO DE TRANSPORTE ENTRADA" ReadOnly="True" VisibleIndex="33" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ENTRADA DESCRIPCION" ReadOnly="True" VisibleIndex="34" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CURP APODERADO MANDATARIO" FieldName="CURP APODERADO MANDATARIO" ReadOnly="True" VisibleIndex="35" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                              
                        <dx:GridViewDataTextColumn Caption="RFC AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="36" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DÓLARES" FieldName="VALOR DOLARES" ReadOnly="True" VisibleIndex="37" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANAL" FieldName="VALOR ADUANAL" ReadOnly="True" VisibleIndex="38" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL" FieldName="VALOR COMERCIAL" ReadOnly="True" VisibleIndex="39" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                    </Columns>

<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_EstadoCuenta.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_EstadoCuenta" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="PATENTE" FieldName="PATENTE" ReadOnly="True" VisibleIndex="1" Width="105px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <%--<dx:GridViewDataTextColumn Caption="NÚMERO</br>PEDIMENTO" FieldName="NUMEROPEDIMENTO" ReadOnly="True" VisibleIndex="2" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>--%>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO" FieldName="PEDIMENTOARMADO" ReadOnly="True" VisibleIndex="3" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        

                        <dx:GridViewDataTextColumn Caption="CLAVE</br>PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="3" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO</br>PEDIMENTO" FieldName="TIPO PEDIMENTO" ReadOnly="True" VisibleIndex="3" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA</br>PEDIMENTO" FieldName="FECHA" ReadOnly="True" VisibleIndex="3" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA</br>PEDIMENTO ORIGINAL" FieldName="FECHA" ReadOnly="True" VisibleIndex="3" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        
                        
                        <dx:GridViewDataTextColumn Caption="PREV" FieldName="PREV" ReadOnly="True" VisibleIndex="4" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA" FieldName="DTA" ReadOnly="True" VisibleIndex="5" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA" FieldName="IVA" ReadOnly="True" VisibleIndex="6" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGIE" FieldName="IGIE" ReadOnly="True" VisibleIndex="7" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CNT" FieldName="CNT" ReadOnly="True" VisibleIndex="8" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS" FieldName="IEPS" ReadOnly="True" VisibleIndex="9" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RECARGOS" FieldName="RECARGOS" ReadOnly="True" VisibleIndex="10" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MULTAS" FieldName="MULTAS" ReadOnly="True" VisibleIndex="11" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL </br>CONTRIBUCIONES" FieldName="TOTALCONTRIBUCIONES" ReadOnly="True" VisibleIndex="12" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONTO</br>BANCOS" FieldName="MONTOBANCOS" ReadOnly="True" VisibleIndex="13" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA" FieldName="DIFERENCIA" ReadOnly="True" VisibleIndex="14" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n2}" />

...
{
    public partial class IG_Partidas : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarPartidas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Partidas");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Partidas", new XlsExportOptionsEx() { SheetName = "Partidas" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Partidas", new XlsxExportOptionsEx() { SheetName = "Partidas" });
                        break;
                    default:
                        break;
                }

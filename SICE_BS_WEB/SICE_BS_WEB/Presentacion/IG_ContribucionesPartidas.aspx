<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_ContribucionesPartidas.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_ContribucionesPartidas" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="IMPORTE CLAVE" FieldName="IMPORTE CLAVE" ReadOnly="True" VisibleIndex="11" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IMPORTE DESCRIPCIÓN" FieldName="IMPORTE DESCRIPCIÓN" ReadOnly="True" VisibleIndex="12" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IMPORTE FORMA DE PAGO CLAVE" FieldName="IMPORTE FORMA DE PAGO CLAVE" ReadOnly="True" VisibleIndex="13" Width="290px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FORMA DE PAGO DESCRIPCIÓN" FieldName="FROMA DE PAGO DESCRIPCIÓN" ReadOnly="True" VisibleIndex="14" Width="320px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>

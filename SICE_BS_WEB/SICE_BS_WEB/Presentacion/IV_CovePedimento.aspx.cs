...
{
    public partial class IV_CovePedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarCovePedimento(dateDesde, dateHasta, PEDIMENTO.Text, COVE.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("COVE Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("COVE Pedimento", new XlsExportOptionsEx() { SheetName = "COVE Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("COVE Pedimento", new XlsxExportOptionsEx() { SheetName = "COVE Pedimento" });
                        break;
                    default:
                        break;
                }

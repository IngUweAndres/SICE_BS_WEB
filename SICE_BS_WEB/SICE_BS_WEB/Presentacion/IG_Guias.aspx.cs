...
{
    public partial class IG_Guias : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("Guias", PEDIMENTO.Text, dateDesde, dateHasta, ref mensaje);
            dt = infogral.ConsultarGuias(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Guías");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Guías", new XlsExportOptionsEx() { SheetName = "Guías" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Guías", new XlsxExportOptionsEx() { SheetName = "Guías" });
                        break;
                    default:
                        break;
                }

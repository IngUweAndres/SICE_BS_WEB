<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="CargasDataStage.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.CargasDataStage" %>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body" >
            <asp:Panel ID="Panel1" runat="server">
                   ...
                   <br />
                   <dx:ASPxUploadControl ID="ASPxUploadControl1" runat="server" OnFileUploadComplete="ASPxUploadControl1_FileUploadComplete" ShowProgressPanel="True" ShowUploadButton="True" UploadMode="Advanced" Width="320px" >
                   ...
                   <br />
                   <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange"  KeyFieldName="FILESDSKEY" OnCustomCallback="Grid_CustomCallback" 
                       EnableCallBacks="false" AutoGenerateColumns="False" OnCustomButtonCallback="ASPxGridView1_CustomButtonCallback" 
                       OnCustomButtonInitialize="ASPxGridView1_CustomButtonInitialize" SettingsPager-Position="TopAndBottom"
                       Styles-Header-ForeColor="#FFF" Styles-Header-Font-Size="11px" Styles-Cell-Font-Size="11px" Width="100%" 
                       Settings-HorizontalScrollBarMode="Auto" ClientInstanceName="grid" SettingsPager-Mode="ShowAllRecords">
                       ...
                       <Columns>
                           ...
                           <dx:GridViewDataTextColumn Caption="FILESDSKEY" FieldName="FILESDSKEY" ReadOnly="True" Visible="False" VisibleIndex="1">
                           </dx:GridViewDataTextColumn>
                           <dx:GridViewDataTextColumn Caption="DSNAME" FieldName="DSNAME" VisibleIndex="2" Width="210px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataTextColumn>
                           <dx:GridViewDataDateColumn Caption="DESDE" FieldName="DESDE" VisibleIndex="3" Width="110px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataDateColumn>
                           <dx:GridViewDataDateColumn Caption="HASTA" FieldName="HASTA" VisibleIndex="4" Width="110px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataDateColumn>
                           <dx:GridViewDataTextColumn Caption="STATUSDS" FieldName="STATUSDS" VisibleIndex="5" Width="120px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <CellStyle HorizontalAlign="Center" />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataTextColumn>
                           <dx:GridViewDataTextColumn Caption="OBSERVACIONES" FieldName="OBSERVACIONES" VisibleIndex="6" Width="250px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataTextColumn>
                           <dx:GridViewDataTextColumn Caption="REGISTROS501" FieldName="REGISTROS501" VisibleIndex="7"  Width="130px">
                                <HeaderStyle HorizontalAlign="Center" ForeColor="#FFF"  />
                                <SettingsHeaderFilter Mode="CheckedList" />
                           </dx:GridViewDataTextColumn>
                           <dx:GridViewCommandColumn Caption="DESCARGAR ARCHIVO" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="#FFFFFF" ButtonRenderMode="Image" VisibleIndex="8" Width="130px" Visible="false">
                               <CustomButtons>
                           ...
                           <dx:GridViewCommandColumn Caption="PROCESAR ARCHIVO" HeaderStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="#FFFFFF" ButtonRenderMode="Image" VisibleIndex="9" Width="130px">
                               <CustomButtons>

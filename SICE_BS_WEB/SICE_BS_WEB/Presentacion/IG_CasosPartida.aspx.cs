...
{
    public partial class IG_CasosPartida : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarCasosPartida(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Casos de la Partida");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Casos de la Partida", new XlsExportOptionsEx() { SheetName = "Casos de la Partida" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Casos de la Partida", new XlsxExportOptionsEx() { SheetName = "Casos de la Partida" });
                        break;
                    default:
                        break;
                }
        ...
        protected void lkb_Excel_Click(object sender, EventArgs e)
        {
            ...
            {
                //LoadingPanel1.Cli
                Exporter.WriteXlsToResponse("Casos de la Partida", new XlsExportOptionsEx() { SheetName = "Cuentas Aduaneras de Garantía del Pedimento" });
            }
            else
                AlertError("No hay información por exportar");

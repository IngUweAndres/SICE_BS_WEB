...
{
    public partial class IG_FechasPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            //dt = infogral.ConsultarContenedores("FechasPedimento", PEDIMENTO.Text, dateDesde, dateHasta, ref mensaje);
            dt = infogral.ConsultarFechasPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Fechas Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Fechas Pedimento", new XlsExportOptionsEx() { SheetName = "Fechas Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Fechas Pedimento", new XlsxExportOptionsEx() { SheetName = "Fechas Pedimento" });
                        break;
                    default:
                        break;
                }

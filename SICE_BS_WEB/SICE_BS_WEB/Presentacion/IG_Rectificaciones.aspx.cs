...
{
    public partial class IG_Rectificaciones : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarRectificaciones(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Rectificaciones");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Rectificaciones", new XlsExportOptionsEx() { SheetName = "Rectificaciones" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Rectificaciones", new XlsxExportOptionsEx() { SheetName = "Rectificaciones" });
                        break;
                    default:
                        break;
                }

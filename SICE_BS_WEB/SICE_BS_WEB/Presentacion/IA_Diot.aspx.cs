...
{
    public partial class IA_Diot : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                excepcion.RegistrarExcepcion(idusuario, "IA_Diot-Page_Load", ex, lblCadena.Text, ref mensaje);
                if (mensaje.Length == 0)
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarDIOT(dateDesde, dateHasta, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("DIOT");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("DIOT", new XlsExportOptionsEx() { SheetName = "DIOT" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("DIOT", new XlsxExportOptionsEx() { SheetName = "DIOT" });
                        break;
                    default:
                        break;
                }

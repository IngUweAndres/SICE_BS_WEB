<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_Facturas.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_Facturas" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="FECHA PEDIMENTO" FieldName="FECHA PEDIMENTO" ReadOnly="True" VisibleIndex="2" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        ...
                        <dx:GridViewDataTextColumn Caption="TIPO DE PEDIMENTO" FieldName="TIPO PEDIMENTO" ReadOnly="True" VisibleIndex="5" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN DE LA CLAVE PEDIMENTO" FieldName="DESCRIPCION DE LA CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="9" Width="570px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA" FieldName="FECHA" ReadOnly="True" VisibleIndex="10" Width="190px">
                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="NÚMERO" FieldName="NUMERO" ReadOnly="True" VisibleIndex="11" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TERMINO FACTURACIÓN CLAVE" FieldName="TERMINO FACTURACION CLAVE" ReadOnly="True" VisibleIndex="12" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TERMINO FACTURACIÓN DESCRIPCIÓN" FieldName="TERMINO FACTURACION DESCRIPCION" ReadOnly="True" VisibleIndex="13" Width="440px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONEDA CLAVE" FieldName="MONEDA CLAVE" ReadOnly="True" VisibleIndex="14" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONEDA DESCRIPCIÓN" FieldName="MONEDA DESCRIPCION" ReadOnly="True" VisibleIndex="15" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DÓLARES" FieldName="VALOR DOLARES" ReadOnly="True" VisibleIndex="16" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="VALOR MONEDA EXTRANJERA" FieldName="VALOR MONEDA EXTRANJERA" ReadOnly="True" VisibleIndex="17" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="R.F.C. PROVEEDOR/COMPRADOR" FieldName="RFC PROVEEDOR/COMPRADOR" ReadOnly="True" VisibleIndex="18" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PROVEEDOR/COMPRADOR" FieldName="PROVEEDOR/COMPRADOR" ReadOnly="True" VisibleIndex="19" Width="330px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA ENTRADA/PRESENTACIÓN" FieldName="FECHA ENTRADA / PRESENTACION" ReadOnly="True" VisibleIndex="20" Width="280px">
                            <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="PAÍS DESTINO" FieldName="PAIS DESTINO" ReadOnly="True" VisibleIndex="21" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PAÍS DESTINO" FieldName="CLAVE PAIS DESTINO" ReadOnly="True" VisibleIndex="22" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE ADUANA" FieldName="CLAVE ADUANA" ReadOnly="True" VisibleIndex="23" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ADUANA" FieldName="ADUANA" ReadOnly="True" VisibleIndex="24" Width="330px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PESO BRUTO" FieldName="PESO BRUTO" ReadOnly="True" VisibleIndex="25" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="26" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA" FieldName="MEDIO DE TRANSPORTE SALIDA" ReadOnly="True" VisibleIndex="27" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE SALIDA DESCRIPCION" ReadOnly="True" VisibleIndex="28" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO" FieldName="MEDIO DE TRANSPORTE ARRIBO" ReadOnly="True" VisibleIndex="29" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ARRIBO DESCRIPCION" ReadOnly="True" VisibleIndex="30" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA" FieldName="MEDIO DE TRANSPORTE ENTRADA" ReadOnly="True" VisibleIndex="31" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ENTRADA DESCRIPCION" ReadOnly="True" VisibleIndex="32" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CURP APODERADO MANDATARIO" FieldName="CURP APODERADO MANDATARIO" ReadOnly="True" VisibleIndex="33" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                              
                        <dx:GridViewDataTextColumn Caption="RFC AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="34" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="VALOR DOLARES" FieldName="VALOR_DOLARES" ReadOnly="True" VisibleIndex="35" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANAL" FieldName="VALOR ADUANAL" ReadOnly="True" VisibleIndex="36" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL" FieldName="VALOR COMERCIAL" ReadOnly="True" VisibleIndex="37" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn Caption="FACTURA" FieldName="FACTURA" ReadOnly="True" VisibleIndex="38" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FECHA FACTURA" FieldName="FECHA FACTURA" ReadOnly="True" VisibleIndex="39" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONTO FACTURA" FieldName="MONTO FACTURA" ReadOnly="True" VisibleIndex="40" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FLETES" FieldName="FLETES" ReadOnly="True" VisibleIndex="41" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SEGUROS" FieldName="SEGUROS" ReadOnly="True" VisibleIndex="42" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="EMBALAJES" FieldName="EMBALAJES" ReadOnly="True" VisibleIndex="43" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="OTROS INCREMENTABLES" FieldName="OTROS INCREMENTABLES" ReadOnly="True" VisibleIndex="43" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="DOMICILIO" FieldName="DOMICILIO" ReadOnly="True" VisibleIndex="45" Width="750px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                     
                    </Columns>

<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_Rectificaciones.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_Rectificaciones" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="10" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANAL RECTIFICACION" FieldName="VALOR ADUANAL RECTIFICACION" ReadOnly="True" VisibleIndex="31" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL RECTIFICACION" FieldName="VALOR COMERCIAL RECTIFICACION" ReadOnly="True" VisibleIndex="32" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE ORIGINAL" FieldName="CLAVE ORIGINAL" ReadOnly="True" VisibleIndex="33" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA ENTRADA ORIGINAL" FieldName="FECHA ENTRADA ORIGINAL" ReadOnly="True" VisibleIndex="34" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA PAGO ORIGINAL" FieldName="FECHA PAGO ORIGINAL" ReadOnly="True" VisibleIndex="35" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANAL ORIGINAL" FieldName="VALOR ADUANAL ORIGINAL" ReadOnly="True" VisibleIndex="36" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL ORIGINAL" FieldName="VALOR COMERCIAL ORIGINAL" ReadOnly="True" VisibleIndex="37" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DIFERENCIA" FieldName="DIFERENCIA" ReadOnly="True" VisibleIndex="38" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                          
                    </Columns>                    

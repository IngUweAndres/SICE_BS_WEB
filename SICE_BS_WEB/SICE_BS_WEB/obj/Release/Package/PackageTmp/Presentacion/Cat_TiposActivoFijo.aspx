<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="Cat_TiposActivoFijo.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.Cat_TiposActivoFijo" %>
             ...
             <div class="panel-body">
                 ...
                 <%--<div class="row" style="padding-left:10px; padding-top:10px; padding-right:10px;">   --%>                                     
                    <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                        ...
                        AutoGenerateColumns="False" Width="100%" Settings-HorizontalScrollBarMode="Auto" KeyFieldName="TIPOACTIVOKEY" SettingsPager-Position="TopAndBottom"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="TIPOACTIVOKEY" ReadOnly="True"  Visible="false" >                                
                            </dx:GridViewDataTextColumn>                            
                            <dx:GridViewDataTextColumn Caption="TIPO ACTIVO FIJO" FieldName="TIPOACTIVOFIJO" ReadOnly="True" VisibleIndex="1" Width="100%" >
                        ...
                        <dx:GridViewToolbar Name="Toolbar1" EnableAdaptivity="true" ItemAlign="Left">
                            <Items>
                                ...
                                <Template>
                                    <asp:LinkButton ID="lkb_Nuevo" runat="server" OnClick="lkb_Nuevo_Click" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Nuevo Tipo Activo Fijo" data-toggle="tooltip">
                                        <span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Nuevo
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lkb_Editar" runat="server" OnClick="lkb_Editar_Click" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Editar Tipo Activo Fijo" data-toggle="tooltip">
                                        <span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Editar
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="lkb_Eliminar" runat="server" OnClick="lkb_Eliminar_Click" OnClientClick="alertQuestion('¿Desea eliminar este tipo de activo fijo?', this); return false;" CssClass="btn btn-primary btn-sm txt-sm margin-top-bottom-button" ToolTip="Eliminar Tipo Activo Fijo" data-toggle="tooltip">
                        ...
                        <div class="row">
                            <div class="col-md-12">                                
                                <div runat="server" id="Div1">
                                    <div class="form-group" style="position: relative; width: 100%; float: left;" title="Tipo Activo Fijo" data-toggle="tooltip">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="basic-addon1">
                                                <span class="glyphicon glyphicon-tags" aria-hidden="true"></span>
                                            </span>
                                            <asp:TextBox ID="txt_TipoActivoFijo" runat="server" CssClass="form-control input-sm" MaxLength="50" placeholder="* Tipo de Activo Fijo"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>                                

...
{
    public partial class IG_CadenaRectificaciones : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarCadenaRectificaciones(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Cadena de Rectificaciones");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Cadena de Rectificaciones", new XlsExportOptionsEx() { SheetName = "Cadena de Rectificaciones" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Cadena de Rectificaciones", new XlsxExportOptionsEx() { SheetName = "Cadena de Rectificaciones" });
                        break;
                    default:
                        break;
                }

<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_Partidas.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_Partidas" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn Caption="FECHA" FieldName="FECHA" ReadOnly="True" VisibleIndex="2" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE OPERACIÓN" FieldName="TIPO DE OPERACION" ReadOnly="True" VisibleIndex="3" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN TIPO PEDIMENTO" FieldName="DESCRIPCION TIPO PEDIMENTO" ReadOnly="True" VisibleIndex="6" Width="290px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="CLAVE PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="8" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN DE LA CLAVE PEDIMENTO" FieldName="DESCRIPCION DE LA CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="9" Width="580px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                                
                        <dx:GridViewDataTextColumn Caption="PARTIDA" FieldName="PARTIDA" ReadOnly="True" VisibleIndex="10" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FRACCION ARANCELARIA" FieldName="FRACCION ARANCELARIA" ReadOnly="True" VisibleIndex="11" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SUBDIVISION FRACCION" FieldName="SUBDIVISION FRACCION" ReadOnly="True" VisibleIndex="12" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCION MERCANCIA" FieldName="DESCRIPCION MERCANCIA" ReadOnly="True" VisibleIndex="13" Width="1500px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE UNIDAD DE MEDIDA TARIFA" FieldName="CLAVE UNIDAD DE MEDIDA TARIFA" ReadOnly="True" VisibleIndex="14" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN UNIDAD DE MEDIDA TARIFA" FieldName="DESCRIPCIÓN UNIDAD DE MEDIDA TARIFA" ReadOnly="True" VisibleIndex="15" Width="340px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CANTIDAD UNIDAD DE MEDIDA TARIFA" FieldName="CANTIDAD UNIAD DE MEDIDA TARIFA" ReadOnly="True" VisibleIndex="16" Width="310px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE UNIDAD DE MEDIDA COMERCIAL" FieldName="CLAVE UNIDAD DE MEDIDA COMERCIAL" ReadOnly="True" VisibleIndex="17" Width="310px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN UNIDAD DE MEDIDA COMERCIAL" FieldName="DESCRIPCIÓN UNIDAD DE MEDIDA COMERCIAL" ReadOnly="True" VisibleIndex="18" Width="350px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CANTIDAD UNIDAD DE MEDIDA COMERCIAL" FieldName="CANTIDAD UNIDAD DE MEDIDA COMERCIAL" ReadOnly="True" VisibleIndex="19" Width="330px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PRECIO UNITARIO" FieldName="PRECIO UNITARIO" ReadOnly="True" VisibleIndex="20" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL" FieldName="VALOR COMERCIAL" ReadOnly="True" VisibleIndex="21" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANA" FieldName="VALOR ADUANA" ReadOnly="True" VisibleIndex="22" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DOLARES" FieldName="VALOR DOLARES" ReadOnly="True" VisibleIndex="23" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR AGREGADO" FieldName="VALOR AGREGADO" ReadOnly="True" VisibleIndex="24" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CODIGO DEL PRODUCTO" FieldName="CODIGO DEL PRODUCTO" ReadOnly="True" VisibleIndex="25" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MARCA" FieldName="MARCA" ReadOnly="True" VisibleIndex="26" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MODELO" FieldName="MODELO" ReadOnly="True" VisibleIndex="27" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="METODO DE VALORACION" FieldName="METODO DE VALORACION" ReadOnly="True" VisibleIndex="28" Width="480px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VINCULACIÓN" FieldName="VINCULACION" ReadOnly="True" VisibleIndex="29" Width="410px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PAIS ORIGEN DESTINO" FieldName="CLAVE PAIS ORIGEN DESTINO" ReadOnly="True" VisibleIndex="30" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN PAIS ORIGEN DESTINO" FieldName="DESCRIPCIÓN PAIS ORIGEN DESTINO" ReadOnly="True" VisibleIndex="31" Width="400px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PAIS VENDEDOR COMPRADOR" FieldName="CLAVE PAIS VENDEDOR COMPRADOR" ReadOnly="True" VisibleIndex="32" Width="310px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN PAIS VENDEDOR COMPRADOR" FieldName="DESCRIPCIÓN PAIS VENDEDOR COMPRADOR" ReadOnly="True" VisibleIndex="33" Width="400px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CODIGO PRODUCTO" FieldName="CODIGO PRODUCTO" ReadOnly="True" VisibleIndex="34" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE PAÍS DESTINO" FieldName="CLAVE PAIS DESTINO" ReadOnly="True" VisibleIndex="35" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                       
                        <dx:GridViewDataTextColumn Caption="PAÍS DESTINO" FieldName="PAIS DESTINO" ReadOnly="True" VisibleIndex="36" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="CLAVE ADUANA" FieldName="CLAVE ADUANA" ReadOnly="True" VisibleIndex="37" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ADUANA" FieldName="ADUANA" ReadOnly="True" VisibleIndex="38" Width="480px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PESO BRUTO" FieldName="PESO BRUTO" ReadOnly="True" VisibleIndex="39" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="40" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA" FieldName="MEDIO DE TRANSPORTE SALIDA" ReadOnly="True" VisibleIndex="41" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE SALIDA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE SALIDA DESCRIPCION" ReadOnly="True" VisibleIndex="42" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO" FieldName="MEDIO DE TRANSPORTE ARRIBO" ReadOnly="True" VisibleIndex="43" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ARRIBO DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ARRIBO DESCRIPCION" ReadOnly="True" VisibleIndex="44" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA" FieldName="MEDIO DE TRANSPORTE ENTRADA" ReadOnly="True" VisibleIndex="45" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE ENTRADA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ENTRADA DESCRIPCION" ReadOnly="True" VisibleIndex="46" Width="360px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CURP APODERADO MANDATARIO" FieldName="CURP APODERADO MANDATARIO" ReadOnly="True" VisibleIndex="47" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                              
                        <dx:GridViewDataTextColumn Caption="RFC AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="48" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR DÓLARES PEDIMENTO" FieldName="VALOR DOLARES PEDIMENTO" ReadOnly="True" VisibleIndex="49" Width="250px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="VALOR ADUANA PEDIMENTO" FieldName="VALOR ADUANAL PEDIMENTO" ReadOnly="True" VisibleIndex="50" Width="250px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR COMERCIAL PEDIMENTO" FieldName="VALOR COMERCIAL PEDIMENTO" ReadOnly="True" VisibleIndex="51" Width="250px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                    </Columns>

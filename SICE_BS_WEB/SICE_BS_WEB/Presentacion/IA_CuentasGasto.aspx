<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IA_CuentasGasto.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IA_CuentasGasto" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    Settings-HorizontalScrollBarMode="Auto" SettingsPager-Position="TopAndBottom" Styles-Header-Font-Size="11px" Styles-Cell-Font-Size="11px">
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="LINEA" FieldName="LINEA" ReadOnly="True" VisibleIndex="1" Width="80px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO <BR/> COMPLETO" FieldName="PEDIMENTO COMPLETO" ReadOnly="True" VisibleIndex="2" Width="130px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA <BR/> DE PAGO" FieldName="FECHA PAGO" ReadOnly="True" VisibleIndex="3" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA <BR/> CUENTA" FieldName="FECHA CUENTA" ReadOnly="True" VisibleIndex="4" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="TIPO <BR/> OPERACIÓN" FieldName="TIPO OPERACIÓN" ReadOnly="True" VisibleIndex="5" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE <BR/> PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="6" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO <BR/> PEDIMENTO" FieldName="TIPO DE PEDIMENTO" ReadOnly="True" VisibleIndex="7" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO <BR/> ORIGINAL" FieldName="PEDIMENTO ORIGINAL" ReadOnly="True" VisibleIndex="8" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FOLIO INTERNO <BR/> PROVEEDOR" FieldName="FOLIO INTERNO PROVEEDOR" ReadOnly="True" VisibleIndex="9" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="AGENCIA <BR/> ADUANAL" FieldName="AGENCIA ADUANAL" ReadOnly="True" VisibleIndex="10" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="NO PROVEEDOR <BR/> SAP" FieldName="NO PROVEEDOR SAP" ReadOnly="True" VisibleIndex="11" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PROVEEDOR CUENTA <BR/> DE GASTOS" FieldName="PROVEEDOR" ReadOnly="True" VisibleIndex="12" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RFC <BR/> PROVEEDOR" FieldName="RFCPROVEEDOR" ReadOnly="True" VisibleIndex="13" Width="280px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CONCEPTO" FieldName="CONCEPTO" ReadOnly="True" VisibleIndex="14" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TC" FieldName="TC" ReadOnly="True" VisibleIndex="15" Width="90px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONTO CUENTA <BR/> DE GASTOS" FieldName="MONTO" ReadOnly="True" VisibleIndex="16" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA CUENTA <BR/> DE GASTOS" FieldName="IVA" ReadOnly="True" VisibleIndex="17" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONEDA" FieldName="MONEDA" ReadOnly="True" VisibleIndex="18" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA" FieldName="DTA" ReadOnly="True" VisibleIndex="19" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA <BR/> PEDIMENTO" FieldName="IVAPEDIMENTO" ReadOnly="True" VisibleIndex="20" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS" FieldName="IEPS" ReadOnly="True" VisibleIndex="21" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="IGI/IGIE" FieldName="IGI/IGIE" ReadOnly="True" VisibleIndex="22" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PRV" FieldName="PRV" ReadOnly="True" VisibleIndex="23" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CN" FieldName="CN" ReadOnly="True" VisibleIndex="24" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ISAN" FieldName="ISAN" ReadOnly="True" VisibleIndex="25" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="CC" FieldName="CC" ReadOnly="True" VisibleIndex="26" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="REC" FieldName="REC" ReadOnly="True" VisibleIndex="27" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="OTROS" FieldName="OTROS" ReadOnly="True" VisibleIndex="28" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="MULTAS" FieldName="MULTAS" ReadOnly="True" VisibleIndex="29" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MT" FieldName="MT" ReadOnly="True" VisibleIndex="30" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DFC" FieldName="DFC" ReadOnly="True" VisibleIndex="31" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RETENCIÓN <BR/> IVA" FieldName="RETENCIONIVA" ReadOnly="True" VisibleIndex="32" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="RFC <BR/> PROVEEDOR" FieldName="RFC PROVEEDOR" ReadOnly="True" VisibleIndex="33" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="MONTO TOTAL <BR/> CUENTA" FieldName="MONTO TOTAL CUENTA" ReadOnly="True" VisibleIndex="34" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="IVA TOTAL <BR/> CUENTA" FieldName="IVA TOTAL CUENTA" ReadOnly="True" VisibleIndex="35" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="RETENCIÓN TOTAL <BR/> CUENTA" FieldName="RETENCION TOTAL CUENTA" ReadOnly="True" VisibleIndex="36" Width="135px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                            <CellStyle HorizontalAlign="Right" />
                            <PropertiesTextEdit DisplayFormatString="{0:n4}" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="UUID" FieldName="UUID" ReadOnly="True" VisibleIndex="37" Width="270px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>    
                    </Columns>                    

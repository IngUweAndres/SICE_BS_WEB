<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_Impuestos.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_Impuestos" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO ARMADO" FieldName="PEDIMENTO ARMADO" ReadOnly="True" VisibleIndex="1" Width="210px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA PAGO" FieldName="FECHA DE PAGO" ReadOnly="True" VisibleIndex="2" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA ENTRADA / PRESENTACIÓN" FieldName="FECHA ENTRADA / PRESENTACION" ReadOnly="True" VisibleIndex="3" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO DE OPERACIÓN" FieldName="TIPO OPERACION" ReadOnly="True" VisibleIndex="4" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        ...
                        <dx:GridViewDataTextColumn Caption="CLAVE PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="6" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="DTA FP0" FieldName="DTA FP0" ReadOnly="True" VisibleIndex="8" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA FP6" FieldName="DTA FP6" ReadOnly="True" VisibleIndex="9" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA FP9" FieldName="DTA FP9" ReadOnly="True" VisibleIndex="10" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA FP12" FieldName="DTA FP12" ReadOnly="True" VisibleIndex="11" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA FP13" FieldName="DTA FP13" ReadOnly="True" VisibleIndex="12" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL DTA" FieldName="TOTAL DTA" ReadOnly="True" VisibleIndex="13" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL ECI" FieldName="TOTAL ECI" ReadOnly="True" VisibleIndex="14" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS FP0" FieldName="IEPS FP0" ReadOnly="True" VisibleIndex="15" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS FP6" FieldName="IEPS FP6" ReadOnly="True" VisibleIndex="16" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS FP12" FieldName="IEPS FP12" ReadOnly="True" VisibleIndex="17" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS FP13" FieldName="IEPS FP13" ReadOnly="True" VisibleIndex="18" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS FP22" FieldName="IEPS FP22" ReadOnly="True" VisibleIndex="19" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL IEPS" FieldName="TOTAL IEPS" ReadOnly="True" VisibleIndex="20" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP0" FieldName="IGI/IGE FP0" ReadOnly="True" VisibleIndex="21" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP5" FieldName="IGI/IGE FP5" ReadOnly="True" VisibleIndex="22" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP6" FieldName="IGI/IGE FP6" ReadOnly="True" VisibleIndex="23" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP9" FieldName="IGI/IGE FP9" ReadOnly="True" VisibleIndex="24" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP12" FieldName="IGI/IGE FP12" ReadOnly="True" VisibleIndex="25" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGI/IGE FP13" FieldName="IGI/IGE FP13" ReadOnly="True" VisibleIndex="26" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL IGI/IGIE" FieldName="TOTAL IGI/IGIE" ReadOnly="True" VisibleIndex="27" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL ISAN" FieldName="TOTAL ISAN" ReadOnly="True" VisibleIndex="28" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP0" FieldName="IVA FP0" ReadOnly="True" VisibleIndex="29" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP5" FieldName="IVA FP5" ReadOnly="True" VisibleIndex="30" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP6" FieldName="IVA FP6" ReadOnly="True" VisibleIndex="31" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP9" FieldName="IVA FP9" ReadOnly="True" VisibleIndex="32" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP12" FieldName="IVA FP12" ReadOnly="True" VisibleIndex="33" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP13" FieldName="IVA FP13" ReadOnly="True" VisibleIndex="34" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP18" FieldName="IVA FP18" ReadOnly="True" VisibleIndex="35" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA FP21" FieldName="IVA FP21" ReadOnly="True" VisibleIndex="36" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL IVA" FieldName="TOTAL IVA" ReadOnly="True" VisibleIndex="37" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL PRV" FieldName="TOTAL PRV" ReadOnly="True" VisibleIndex="38" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CN TOTAL" FieldName="CN TOTAL" ReadOnly="True" VisibleIndex="39" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL C.C." FieldName="TOTAL C.C." ReadOnly="True" VisibleIndex="40" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL DFC" FieldName="TOTAL DFC" ReadOnly="True" VisibleIndex="41" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL MT" FieldName="TOTAL MT" ReadOnly="True" VisibleIndex="42" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL MULT." FieldName="TOTAL MULT." ReadOnly="True" VisibleIndex="43" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL OTROS" FieldName="TOTAL OTROS" ReadOnly="True" VisibleIndex="44" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TOTAL REC." FieldName="TOTAL REC." ReadOnly="True" VisibleIndex="28" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                    </Columns>                    

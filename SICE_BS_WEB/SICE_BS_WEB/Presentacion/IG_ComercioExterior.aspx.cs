...
{
    public partial class IG_ComercioExterior : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarComercioExterior(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Informe de Comercio Exterior");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Informe de Comercio Exterior", new XlsExportOptionsEx() { SheetName = "Informe de Comercio Exterior" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Informe de Comercio Exterior", new XlsxExportOptionsEx() { SheetName = "Informe de Comercio Exterior" });
                        break;
                    default:
                        break;
                }

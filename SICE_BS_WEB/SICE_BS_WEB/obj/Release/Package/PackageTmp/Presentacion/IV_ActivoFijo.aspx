<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IV_ActivoFijo.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IV_ActivoFijo" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    KeyFieldName="PEDIMENTOARMADO" SettingsPager-Position="TopAndBottom" Styles-Header-Font-Size="11px" Styles-Cell-Font-Size="11px"
                    >
                    ...
                    <Settings ShowFooter="False" ShowHeaderFilterButton="true" ShowFilterRowMenu="false" HorizontalScrollBarMode="Auto" />                                          
                    <Styles>                                                               
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO<br/>ARMADO" FieldName="PEDIMENTOARMADO" ReadOnly="True" VisibleIndex="1" Width="140px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA PAGO" FieldName="FECHA" ReadOnly="True" VisibleIndex="2" Width="100px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                     <%--  <dx:GridViewDataTextColumn Caption="TIPO DE<br/>OPERACIÓN" FieldName="TIPO DE OPERACION" ReadOnly="True" VisibleIndex="3" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN TIPO<br/>DE OPERACIÓN" FieldName="DESCRIPCION TIPO DE OPERACION" ReadOnly="True" VisibleIndex="4" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  --%> 
                        <dx:GridViewDataTextColumn Caption="CLAVE<br/>PEDIMENTO" FieldName="CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="3" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN<br/>CLAVE PEDIMENTO" FieldName="DESCRIPCION DE LA CLAVE PEDIMENTO" ReadOnly="True" VisibleIndex="4" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                     <%--   <dx:GridViewDataTextColumn Caption="CLAVE<br/>PAÍS DESTINO" FieldName="CLAVE PAIS DESTINO" ReadOnly="True" VisibleIndex="7" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PAÍS<br/>DESTINO" FieldName="PAIS DESTINO" ReadOnly="True" VisibleIndex="8" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> --%>
                        <dx:GridViewDataTextColumn Caption="CLAVE<br/>ADUANA" FieldName="CLAVE ADUANA" ReadOnly="True" VisibleIndex="5" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ADUANA" FieldName="ADUANA" ReadOnly="True" VisibleIndex="6" Width="320px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                     <%--   <dx:GridViewDataTextColumn Caption="PESO<br/>BRUTO" FieldName="PESO BRUTO" ReadOnly="True" VisibleIndex="11" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>SALIDA" FieldName="MEDIO DE TRANSPORTE SALIDA" ReadOnly="True" VisibleIndex="13" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>SALIDA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE SALIDA DESCRIPCION" ReadOnly="True" VisibleIndex="14" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>ARRIBO" FieldName="MEDIO DE TRANSPORTE ARRIBO" ReadOnly="True" VisibleIndex="15" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>ARRIBO DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ARRIBO DESCRIPCION" ReadOnly="True" VisibleIndex="16" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>ENTRADA" FieldName="MEDIO DE TRANSPORTE ENTRADA" ReadOnly="True" VisibleIndex="17" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIO DE TRANSPORTE<br/>ENTRADA DESCRIPCIÓN" FieldName="MEDIO DE TRANSPORTE ENTRADA DESCRIPCION" ReadOnly="True" VisibleIndex="18" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CURP APODERADO<br/>MANDATARIO" FieldName="CURP APODERADO MANDATARIO" ReadOnly="True" VisibleIndex="19" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                                              
                        <dx:GridViewDataTextColumn Caption="RFC<br/>AGENTE ADUANAL" FieldName="RFC AGENTE ADUANAL" ReadOnly="True" VisibleIndex="20" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn Caption="TIPO DE<br/>PEDIMENTO" FieldName="TIPO DE PEDIMENTO" ReadOnly="True" VisibleIndex="23" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> --%>
                        <dx:GridViewDataTextColumn Caption="TIPO<br/>PEDIMENTO" FieldName="TIPO_PED" ReadOnly="True" VisibleIndex="7" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                      <%--  <dx:GridViewDataTextColumn Caption="COMPLETO<br/>VALIDADO" FieldName="COMPLETOVALIDADO" ReadOnly="True" VisibleIndex="25" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  --%>
                        <dx:GridViewDataDateColumn Caption="FECHA<br/>PAGO ORIGINAL" FieldName="FECHA PAGO ORIGINAL" ReadOnly="True" VisibleIndex="8" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA<br/>ENTRADA / PRESENTACION" FieldName="FECHA ENTRADA / PRESENTACION" ReadOnly="True" VisibleIndex="9" Width="200px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                     <%--   <dx:GridViewDataTextColumn Caption="ACTIVOFIJOKEY" FieldName="ACTIVOFIJOKEY" ReadOnly="True" VisibleIndex="28" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  --%>
                        <dx:GridViewDataTextColumn Caption="TIPOACTIVOFIJO" FieldName="TIPOACTIVOFIJO" ReadOnly="True" VisibleIndex="10" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FOLIO<br/>INTERNO" FieldName="FOLIOINTERNO" ReadOnly="True" VisibleIndex="11" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PO" FieldName="PO" ReadOnly="True" VisibleIndex="12" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN" FieldName="DESCRIPCION" ReadOnly="True" VisibleIndex="13" Width="400px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN TÉCNICA" FieldName="DESCRIPCIONTECNICA" ReadOnly="True" VisibleIndex="14" Width="400px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FRACCIÓN" FieldName="FRACCION" ReadOnly="True" VisibleIndex="15" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PARTIDA" FieldName="PARTIDA" ReadOnly="True" VisibleIndex="16" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MARCA" FieldName="MARCA" ReadOnly="True" VisibleIndex="17" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MODELO" FieldName="MODELO" ReadOnly="True" VisibleIndex="18" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SERIE" FieldName="SERIE" ReadOnly="True" VisibleIndex="19" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE<br/>PAÍS ORIGEN" FieldName="CLAVEPAISORIGEN" ReadOnly="True" VisibleIndex="20" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR<br/>ADUANAL" FieldName="VALOR ADUANAL" ReadOnly="True" VisibleIndex="21" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                       
                        <dx:GridViewDataTextColumn Caption="VALOR<br/>COMERCIAL" FieldName="VALOR COMERCIAL" ReadOnly="True" VisibleIndex="22" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TIPO<br/>DE CAMBIO" FieldName="TIPO DE CAMBIO" ReadOnly="True" VisibleIndex="23" Width="120px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR MONEDA<br/> EXTRANJERA" FieldName="VALORME" ReadOnly="True" VisibleIndex="24" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MONEDA<br/> EXTRANJERA" FieldName="ME" ReadOnly="True" VisibleIndex="25" Width="140px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="USUARIO<br/>ALTA" FieldName="USUARIOALTA" ReadOnly="True" VisibleIndex="26" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA<br/>ALTA" FieldName="FECHAALTA" ReadOnly="True" VisibleIndex="27" Width="110px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                    <%--    <dx:GridViewDataTextColumn Caption="RELACIÓN<br/>PEDIMENTOKEY" FieldName="RELACIONPEDIMENTOKEY" ReadOnly="True" VisibleIndex="28" Width="150px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ACTIVOFIJOKEY_1" FieldName="ACTIVOFIJOKEY_1" ReadOnly="True" VisibleIndex="29" Width="160px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO" FieldName="PEDIMENTO" ReadOnly="True" VisibleIndex="30" Width="130px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>       --%>                             
                    </Columns>                    

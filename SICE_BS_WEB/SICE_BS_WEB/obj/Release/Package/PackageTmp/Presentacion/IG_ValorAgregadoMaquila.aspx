<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_ValorAgregadoMaquila.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_ValorAgregadoMaquila" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO" FieldName="PEDIMENTO" ReadOnly="True" VisibleIndex="1" Width="190px" >
                        ...
                        <dx:GridViewDataTextColumn Caption="PARTIDA" FieldName="PARTIDA" ReadOnly="True" VisibleIndex="7" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="FRACCIÓN" FieldName="FRACCION" ReadOnly="True" VisibleIndex="8" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="VALOR AGREGADO MXP" FieldName="VALOR AGREGADO MXP" ReadOnly="True" VisibleIndex="9" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                    </Columns>                    

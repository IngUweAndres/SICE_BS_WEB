...
{
    public partial class IG_TasasPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarTasaPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Tasa del Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Tasa del Pedimento", new XlsExportOptionsEx() { SheetName = "Tasa del Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Tasa del Pedimento", new XlsxExportOptionsEx() { SheetName = "Tasa del Pedimento" });
                        break;
                    default:
                        break;
                }

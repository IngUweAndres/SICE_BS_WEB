...
{
    public partial class IG_PermisosPartida : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarPermisosPartidas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Permisos de la Partida");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Permisos de la Partida", new XlsExportOptionsEx() { SheetName = "Permisos de la Partida" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Permisos de la Partida", new XlsxExportOptionsEx() { SheetName = "Permisos de la Partida" });
                        break;
                    default:
                        break;
                }

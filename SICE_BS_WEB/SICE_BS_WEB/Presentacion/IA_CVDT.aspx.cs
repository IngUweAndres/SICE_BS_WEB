...
{
    public partial class IA_CVDT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                excepcion.RegistrarExcepcion(idusuario, "IA_CVDT-Page_Load", ex, lblCadena.Text, ref mensaje);
                if (mensaje.Length == 0)
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = informes.ConsultarCompulsa(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Compulsa VUCEM vs DATA STAGE");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Compulsa VUCEM vs DATA STAGE", new XlsExportOptionsEx() { SheetName = "Compulsa VUCEM vs DATA STAGE" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Compulsa VUCEM vs DATA STAGE", new XlsxExportOptionsEx() { SheetName = "Compulsa VUCEM vs DATA STAGE" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IG_ObservacionesPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarObservacionesPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Observaciones del Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Observaciones del Pedimento", new XlsExportOptionsEx() { SheetName = "Observaciones del Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Observaciones del Pedimento", new XlsxExportOptionsEx() { SheetName = "Observaciones del Pedimento" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IG_ContribucionesPartidas : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarContribucionesPartidas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Contribuciones de las Partidas");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Contribuciones de las Partidas", new XlsExportOptionsEx() { SheetName = "Contribuciones de las Partidas" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse( "Contribuciones de las Partidas", new XlsxExportOptionsEx() { SheetName = "Contribuciones de las Partidas" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IG_TasasContribucionesPartidas : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarTasasContribucionesPartidas(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Tasas de las Contribuciones de las Partidas");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Tasas de las Contribuciones de las Partidas", new XlsExportOptionsEx() { SheetName = "Tasas de las Contribuciones de las Partidas" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Tasas de las Contribuciones de las Partidas", new XlsxExportOptionsEx() { SheetName = "Tasas de las Contribuciones de las Partidas" });
                        break;
                    default:
                        break;
                }

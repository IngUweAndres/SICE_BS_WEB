...
{
    public partial class IG_ContribucionesPorPedimento : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarContribucionesPorPedimento(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Contribuciones por Pedimento");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Contribuciones por Pedimento", new XlsExportOptionsEx() { SheetName = "Contribuciones por Pedimento" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Contribuciones por Pedimento", new XlsxExportOptionsEx() { SheetName = "Contribuciones por Pedimento" });
                        break;
                    default:
                        break;
                }

...
{
    public partial class IG_TasasPartida : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_OnClick(object sender, EventArgs e)
        {
            ...
            dt = infogral.ConsultarTasasPorPartida(PEDIMENTO.Text, dateDesde, dateHasta, PATENTES.Text, lblCadena.Text, ref mensaje);
        ...
        protected void Grid_ToolbarItemClick(object source, ASPxGridToolbarItemClickEventArgs e)
        {
            if (Grid.VisibleRowCount > 0)
            {
                ...
                {
                    case "ExportToPDF":
                        Exporter.WritePdfToResponse("Informe Tasas por Partida");
                        break;
                    case "ExportToXLS":
                        Exporter.WriteXlsToResponse("Informe Tasas por Partida", new XlsExportOptionsEx() { SheetName = "Informe Tasas por Partida" });
                        break;
                    case "ExportToXLSX":
                        Exporter.WriteXlsxToResponse("Informe Tasas por Partida", new XlsxExportOptionsEx() { SheetName = "Informe Tasas por Partida" });
                        break;
                    default:
                        break;
                }

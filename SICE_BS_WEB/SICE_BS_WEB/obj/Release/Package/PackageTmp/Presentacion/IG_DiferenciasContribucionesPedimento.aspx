<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_DiferenciasContribucionesPedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_DiferenciasContribucionesPedimento" %>
         ...
         <div class="panel panel-primary">
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    Settings-HorizontalScrollBarMode="Auto" KeyFieldName="PEDIMENTO DE RECTIFICACION" SettingsPager-Position="TopAndBottom"
                    ...
                    <Columns>
                        <dx:GridViewDataDateColumn Caption="FECHA RECTIFICACION" FieldName="FECHA RECTIFICACION" ReadOnly="True" VisibleIndex="1" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO DE RECTIFICACION" FieldName="PEDIMENTO DE RECTIFICACION" ReadOnly="True" VisibleIndex="2" Width="230px" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        
                        <dx:GridViewDataTextColumn Caption="DTA PAGADO RECTIFICACION" FieldName="DTA PAGADO RECTIFICACION" ReadOnly="True" VisibleIndex="3" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA PAGADO DIFERENCIA" FieldName="DTA PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="4" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MULTAS PAGADO DIFERENCIA" FieldName="MULTAS PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="5" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RECARGOS PAGADO DIFERENCIA" FieldName="RECARGOS PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="6" Width="240px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA PAGADO DIFERENCIA" FieldName="IVA PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="7" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="IGIE PAGADO DIFERENCIA" FieldName="IGIE PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="8" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ISAN PAGADO DIFERENCIA" FieldName="ISAN PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="9" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS PAGADO DIFERENCIA" FieldName="IEPS PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="10" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MT PAGADO DIFERENCIA" FieldName="MT PAGADO DIFERENCIA" ReadOnly="True" VisibleIndex="11" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO ORIGINAL" FieldName="PEDIMENTO ORIGINAL" ReadOnly="True" VisibleIndex="12" Width="210px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA ORIGINAL" FieldName="FECHA ORIGINAL" ReadOnly="True" VisibleIndex="13" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn> 
                        <dx:GridViewDataTextColumn Caption="DTA ORIGINAL" FieldName="DTA ORIGINAL" ReadOnly="True" VisibleIndex="14" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MULTAS ORIGINAL" FieldName="MULTAS ORIGINAL" ReadOnly="True" VisibleIndex="15" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RECARGOS ORIGINAL" FieldName="RECARGOS ORIGINAL" ReadOnly="True" VisibleIndex="16" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA ORIGINAL" FieldName="IVA ORIGINAL" ReadOnly="True" VisibleIndex="17" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IGIE ORIGINAL" FieldName="IGIE ORIGINAL" ReadOnly="True" VisibleIndex="18" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="ISAN ORIGINAL" FieldName="ISAN ORIGINAL" ReadOnly="True" VisibleIndex="19" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS ORIGINAL" FieldName="IEPS ORIGINAL" ReadOnly="True" VisibleIndex="20" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIDAS DE TRANSICION ORIGINAL" FieldName="MEDIDAS DE TRANSICION ORIGINAL" ReadOnly="True" VisibleIndex="21" Width="290px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DTA RECTIFICADO" FieldName="DTA RECTIFICADO" ReadOnly="True" VisibleIndex="22" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MULTAS RECTIFICADO" FieldName="MULTAS RECTIFICADO" ReadOnly="True" VisibleIndex="23" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="RECARGOS RECTIFICADO" FieldName="RECARGOS RECTIFICADO" ReadOnly="True" VisibleIndex="24" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IVA RECTIFICADO" FieldName="IVA RECTIFICADO" ReadOnly="True" VisibleIndex="25" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn Caption="IGIE RECTIFICADO" FieldName="IGIE RECTIFICADO" ReadOnly="True" VisibleIndex="26" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>  
                        <dx:GridViewDataTextColumn Caption="ISAN RECTIFICADO" FieldName="ISAN RECTIFICADO" ReadOnly="True" VisibleIndex="27" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="IEPS RECTIFICADO" FieldName="IEPS RECTIFICADO" ReadOnly="True" VisibleIndex="28" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="MEDIDAS DE TRANSICION RECTIFICADO" FieldName="MEDIDAS DE TRANSICION RECTIFICADO" ReadOnly="True" VisibleIndex="29" Width="290px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>            
                    </Columns>                    

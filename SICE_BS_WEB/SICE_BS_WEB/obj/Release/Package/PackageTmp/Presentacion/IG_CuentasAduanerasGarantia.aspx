<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_CuentasAduanerasGarantia.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_CuentasAduanerasGarantia" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="CLAVE INSTITUCION EMISORA" FieldName="CLAVE INSTITUCION EMISORA" ReadOnly="True" VisibleIndex="10" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN INSTITUCION EMISORA" FieldName="DESCRIPCIÓN INSTITUCION EMISORA" ReadOnly="True" VisibleIndex="11" Width="530px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="FOLIO CONSTANCIA" FieldName="FOLIO CONSTANCIA" ReadOnly="True" VisibleIndex="13" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataDateColumn Caption="FECHA CONSTANCIA" FieldName="FECHA CONSTANCIA" ReadOnly="True" VisibleIndex="14" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataDateColumn>
                        ...
                        <dx:GridViewDataTextColumn Caption="TIPO GARANTÍA" FieldName="TIPO GARANTÍA" ReadOnly="True" VisibleIndex="16" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CANTIDAD GARANTÍA" FieldName="CANTIDAD GARANTÍA" ReadOnly="True" VisibleIndex="17" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>

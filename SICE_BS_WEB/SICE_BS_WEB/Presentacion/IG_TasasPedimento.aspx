<%@ Page Language="C#" MasterPageFile="~/Presentacion/Principal.Master" AutoEventWireup="true" CodeBehind="IG_TasasPedimento.aspx.cs" Inherits="SICE_BS_WEB.Presentacion.IG_TasasPedimento" %>
             ...
             <div class="panel-body" >
                 ...
                 <dx:ASPxGridView ID="Grid" runat="server" EnableTheming="True" Theme="SoftOrange" OnToolbarItemClick="Grid_ToolbarItemClick"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn Caption="PATENTE" FieldName="PATENTE" ReadOnly="True" VisibleIndex="9" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>                        
                        <dx:GridViewDataTextColumn Caption="PEDIMENTO" FieldName="PEDIMENTO" ReadOnly="True" VisibleIndex="10" Width="190px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="SECCIÓN ADUANERA" FieldName="SECCIÓN ADUANERA" ReadOnly="True" VisibleIndex="11" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE CONTRIBUCIÓN" FieldName="CLAVE_CONTRIBUCIÓN" ReadOnly="True" VisibleIndex="12" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CONTRIBUCIÓN" FieldName="CONTRIBUCIÓN" ReadOnly="True" VisibleIndex="13" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="CLAVE CONTRIBUCIÓN" FieldName="CLAVE CONTRIBUCIÓN" ReadOnly="True" VisibleIndex="14" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="TASA CONTRIBUCIÓN" FieldName="TASA CONTRIBUCIÓN" ReadOnly="True" VisibleIndex="15" Width="230px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="DESCRIPCIÓN TIPO TASA" FieldName="DESCRIPCIÓN TIPO TASA" ReadOnly="True" VisibleIndex="16" Width="260px">
                            <HeaderStyle HorizontalAlign="Center" />
                            <SettingsHeaderFilter Mode="CheckedList" />
                        </dx:GridViewDataTextColumn> 
                        <dx:GridViewDataTextColumn Caption="TIPO TASA" FieldName="TIPO TASA" ReadOnly="True" VisibleIndex="17" Width="170px">
                            <HeaderStyle HorizontalAlign="Center" />
                        </dx:GridViewDataTextColumn>                                         
                    </Columns>
                    <Toolbars>
